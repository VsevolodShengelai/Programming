...
*Рисунок 2. Демонстрация функционала корзины (скриншот1)*

![](./images/pic3.png)

*Рисунок 3. Демонстрация функционала корзины (скриншот2)*

Помощь поможет узнать о назначении кнопок

![](./images/pic4.png)

*Рисунок 4. Демонстрация работы функционала Помощь*
